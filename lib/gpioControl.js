        ...
        try {
            ...
            if (this.gpioChip) {
                ...
                if (buttonPorts.length > 0) {
                    this.log.error('Button ports not yet supported... not sure if they ever will be - please discuss in github: https://github.com/iobroker-community-adapters/ioBroker.rpi2/issues/192 - if no account and have something constructive to add, contact Garfonso.');
