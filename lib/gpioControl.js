        ...
        try {
            ...
            if (this.gpioChip) {
                ...
                if (buttonPorts.length > 0) {
                    this.log.error('Button ports not yet supported... not sure if they ever will be? - please contact Garfonso on github, in forum, telegram or discord and discuss your use case.');
